...
- **商用版**: AGPL-3.0 のコピーレフト義務（ソース開示義務等）を**免除**する有償ライセンス。導入のお問い合わせは **GitHub Issue** でご連絡ください

コントリビューションはデュアルライセンス維持のため [CONTRIBUTING.md](CONTRIBUTING.md) の権利集約条件への同意が必要です。
